...
[![Version](https://img.shields.io/packagist/v/bluehorndigital/entrust.svg)](https://packagist.org/packages/bluehorndigital/entrust)
[![License](https://poser.pugx.org/bluehorndigital/entrust/license.svg)](https://packagist.org/packages/bluehorndigital/entrust)
[![Total Downloads](https://img.shields.io/packagist/dt/bluehorndigital/entrust.svg)](https://packagist.org/packages/bluehorndigital/entrust)

Entrust is a succinct and flexible way to add Role-based Permissions to **Laravel**.

This is a fork maintained by [Bluehorn Digital](https://bluehorn.digital) to support **Laravel 6** and above.
...
```json
"bluehorndigital/entrust": "5.2.x-dev"
```
...
Then register the configuration into your application, so it is recognized by `EntrustServiceProvider`
